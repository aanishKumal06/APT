    ...
    <div class="modal-body">
      <form class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="number" step="1" id="monthlyFee" class="form-input" placeholder="e.g. 250.00">
        </div>
        ...
        <div class="form-group span-2">
          ...
          <div class="checkbox-group" id="roomFacilities">
            <label class="checkbox-label"><input type="checkbox" value="WiFi" checked> WiFi</label>
            <label class="checkbox-label"><input type="checkbox" value="TV"> TV</label>
            <label class="checkbox-label"><input type="checkbox" value="Refrigerator"> Refrigerator</label>
            <label class="checkbox-label"><input type="checkbox" value="Sofa"> Sofa</label>
            <label class="checkbox-label"><input type="checkbox" value="Study Table"> Study Table</label>
            <label class="checkbox-label"><input type="checkbox" value="Attached Bathroom"> Attached Bathroom</label>
            <label class="checkbox-label"><input type="checkbox" value="Wardrobe"> Wardrobe</label>
            <label class="checkbox-label"><input type="checkbox" value="Ceiling Fan"> Ceiling Fan</label>
          </div>
        </div>
